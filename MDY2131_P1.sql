...
--mostrar todos los datos de tabla PROPIEDADES
...
--mostrar direccion, valor arriendo y valor gasto comun
...
--operadores matemáticos sobre empleado
...
,sueldo_emp+1000000 AS "sueldo mas un millon"

,sueldo_emp-1000000 AS "sueldo menos un millon"

,sueldo_emp*12 AS "SUELDO ANUAL"

,sueldo_emp/20 AS "sueldo diario"
...
--dias trabajados en la empresa



SELECT

SYSDATE-fecing_emp --CANTIDAD DIAS TRABAJADOS
...
--cuales son las comunas que poseen propiedades
...
--CLIENTE ORDENADO POR APELLIDO PATERNO ASCENDENTE
...
'el empleado'
    ...
    ||apmaterno_emp
    ||' nacio en '
    || fecnac_emp AS " listado de cumpleaños "
...
nombre_emp,
sueldo_emp,
sueldo_emp*0.5 AS "50% DE SUELDO"
...
nombre_emp
     ...
     || ' '
      AS " NOMBRE EMPLEADO ",
sueldo_emp,
sueldo_emp*0.135+sueldo_emp AS "SUELDO AJUSTADO",
...
(sueldo_emp*0.055)+(sueldo_emp*0.178)+(sueldo_emp*0.078)+(sueldo_emp*0.065) AS "SUELDO LIQUIDO"
